...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Inter:wght@300;400;500;600;700&family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap",
      },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Independent verification of peptide Certificates of Analysis, with a community-funded testing board.",
        }),
      },
    ],
  }),
