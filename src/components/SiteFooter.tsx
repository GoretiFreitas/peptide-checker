      ...
      <div className="mx-auto max-w-[1400px] px-6 py-10 md:px-10 md:py-14">
        <div className="grid gap-8 md:grid-cols-4">
          <div>
            ...
            <p className="mt-3 max-w-[28ch] text-xs leading-relaxed text-muted-foreground">
              Independent, community-funded testing of research peptides.
            </p>
          </div>
        ...
        <div className="mt-10 border-t border-border pt-6">
          ...
          <p className="mt-4 text-[11px] tracking-[0.14em] uppercase text-muted-foreground">
            © {year} Descier Cooperative. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
